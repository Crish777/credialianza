...
<main class="siteMain">
  ...
  <div class="dualContainer">
    <div class="dualTextConatiner" >
      ...
      <h3 class="blueSubtitle" data-aos="fade-left"  data-aos-duration="500">Crédito de libranza para libre inversión</h3>
  ...
  <div class="pannelContainer" style="background-image: url('<?= $themeDirectory; ?>trashimages/pannel2.png');"  data-aos="fade-up"  data-aos-duration="700">
    ...
    <div class="pannelLogoContainer">

      <div class="pannelLogoItem">
        <img src="<?= themeDirectory(); ?>trashimages/Icon1.png" class="pannelLogoIcon">
      </div>
      ...
      <div class="pannelLogoItem">
        <img src="<?= themeDirectory(); ?>trashimages/Icon3.png" class="pannelLogoIcon">
      </div>

      <div class="pannelLogoItem">
        <img src="<?= themeDirectory(); ?>trashimages/Icon4.png" class="pannelLogoIcon">
      </div>
  ...
  <div class="slickContiner gradient-container">
    <div class="slickItem">
      <h2 class="slickTitle">Marisol Rodriguez 1</h2>
      <h3 class="slickSubTitle">Profesora</h3>
      <h4 class="slickAddress">Cali - Valle del Cauca</h4>
      <p class="slickPharagraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
    </div>

    <div class="slickItem">
      <h2 class="slickTitle">Marisol Rodriguez 2</h2>
      <h3 class="slickSubTitle">Profesora</h3>
      <h4 class="slickAddress">Cali - Valle del Cauca</h4>
      <p class="slickPharagraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
    </div>
    ...
    <div class="slickItem">
      <h2 class="slickTitle">Marisol Rodriguez 3</h2>
      <h3 class="slickSubTitle">Profesora</h3>
      <h4 class="slickAddress">Cali - Valle del Cauca</h4>
      <p class="slickPharagraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
    </div>
    ...
    <div class="slickItem">
      <h2 class="slickTitle">Marisol Rodriguez 4</h2>
      <h3 class="slickSubTitle">Profesora</h3>
      <h4 class="slickAddress">Cali - Valle del Cauca</h4>
      <p class="slickPharagraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
    </div>
    ...
    <div class="slickItem">
      <h2 class="slickTitle">Marisol Rodriguez 5</h2>
      <h3 class="slickSubTitle">Profesora</h3>
      <h4 class="slickAddress">Cali - Valle del Cauca</h4>
      <p class="slickPharagraph">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor.</p>
    </div>
