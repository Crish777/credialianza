...
<main class="siteMain">
  ...
  <div class="vualuesPannel">
    ...
    <div class="valuesContainer">
      ...
      <div class="valueItem">
        <h2 class="valueTitle" data-aos="fade-up" data-aos-duration="500">Responsabilidad <br /> <strong>Social</strong>
        </h2>
      ...
      <div class="valueItem">
        <h2 class="valueTitle" data-aos="fade-up" data-aos-duration="500">Transparencia y</br> <strong>
            Honestidad</strong> </h2>
        <p class="valuePharagraph" data-aos="fade-up" data-aos-duration="500">
      ...
      <div class="valueItem">
        <h2 class="valueTitle" data-aos="fade-up" data-aos-duration="500">Máxima calidad </br> <strong>como
            meta</strong> </h2>
        <p class="valuePharagraph" data-aos="fade-up" data-aos-duration="500">
  ...
  <section class="siteSection certificationSection">
    <div class="outerImgCertification">
      <img src="<?= $themeDirectory; ?>trashimages/certified.jpg" alt="">
    </div>
    <div class="certificationsDetails">
      <h2 class="blueTitle certificationTitle">
        <strong>Certificaciones</strong>
      </h2>
      <h3 class="blueSubtitle" data-aos="fade-left" data-aos-duration="500">ISO 9001:2015 Y 45001:2018 BUREAU VERITAS </h3>
      <p class="dualParagraph" data-aos="fade-left" data-aos-duration="500">
        Credialianza en el año 2021 obtuvo la certificación en estándares de gestión y normas reconocidas nacional o
        internacionalmente; en Sistema de Gestión de Calidad (ISO 9001:2015) y Sistema de Seguridad y Salud en el
        Trabajo (ISO 45001:2018) bajo el CERTIFICADO 3129191.
        <br/><br/>
        Permitiendo la mejora continua de la organización. El servicio de certificación y capacitación fue realizado con
        la entidad certificadora BUREAU VERITAS. 0001085 de la Cámara de Comercio de Bogotá D.C.
      </p>
    </div>
  </section>
